export const newsArticles = [
  {
    slug: "saudi-arabia-opens-theme-park-as-kingdom-pushes-ahead-with-mega-projects",
    title:
      "Saudi Arabia opens theme park as kingdom pushes ahead with mega projects",
    date: "14 Jan 2026",
    ...
    content: `
      ...
      <p><br /></p>
      <p>The successful 1bn construction of Six Flags Qiddiya City is a step forward for the country’s rulers after a series of its futuristic gigaprojects have been hit by setbacks.</p>
      <p><br /></p>
      ...
      <p><br /></p>
      <p>The complex is one of five gigaprojects that seek to help the diversification push by investing in promising new sectors for the country, such as tourism and entertainment.</p>
      <p><br /></p>
  ...
  {
    slug: "saudi-arabia-opens-theme-park-as-kingdom-pushes-ahead-with-mega-projects-2",
    title:
      "Saudi Arabia opens  theme park as kingdom pushes ahead with mega projects",
    date: "19 Jan 2026",
    image: "/uploads/5f2821243f54c140.jpg",
    content: `
      <p><span style="color: rgb(69, 76, 96);">Stay updated with the latest from Energizese, a specialized mechanical services firm delivering excellence across Industrial, Commercial, and Residential projects.Stay updated with the latest from Energizese, a specialized mechanical services firm delivering excellence across Industrial, Commercial, and Residential projects.</span></p>
    `,
  },
] as const;
